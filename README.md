...
> This repo implements a reproducible apartment price regression pipeline: data loading → data preprocessing → 5-fold cross-validation → baselines/ensembles → interpretation and ablation.
